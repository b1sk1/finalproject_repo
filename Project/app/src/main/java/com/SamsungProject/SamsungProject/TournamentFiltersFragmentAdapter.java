...
public class TournamentFiltersFragmentAdapter extends BaseExpandableListAdapter {
    ...
    public TournamentFiltersFragmentAdapter(){};
    public TournamentFiltersFragmentAdapter(Activity _context, List<FilterHeader> _listDataHeader, HashMap<String, List<String>> _listDataChild) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        convertView = Objects.requireNonNull(infalInflater).inflate(R.layout.tournamentfilter_header_layout, null);
        //}

        TextView lblListHeader = convertView.findViewById(R.id.tournamentslblListHeader);
        lblListHeader.setTypeface(null, Typeface.BOLD);
        lblListHeader.setText(headerTitle);
        TextView groupStatus = convertView.findViewById(R.id.tournamentsgroupStatus);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        LayoutInflater infalInflater = (LayoutInflater) this._context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        convertView = Objects.requireNonNull(infalInflater).inflate(R.layout.tournamentfilter_child_layout, null);
        // }

        final TextView filterName = convertView
                .findViewById(R.id.tournamentsTextviewFilterName);
        filterName.setText(childText);
        final CheckBox filterCheckBox = convertView.findViewById(R.id.tournamentsFilterNameCheckBox);
        final RadioButton filterRadioButton = convertView.findViewById(R.id.tournamentsFilterNameRadioButton);
    ...
    public void getTournamentAnswer(final DataCallback dataCallback){
        dataCallback.onCallback(answer);
        answer.clear();
    }

    public interface DataCallback{
        void onCallback(ArrayList<String> tournamentsResult);
    }
}
